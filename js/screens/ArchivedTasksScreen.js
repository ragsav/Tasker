...
const enhanceArchivedTasksScreen = withObservables(
...
const EnhancedArchivedTasksScreen =
  enhanceArchivedTasksScreen(ArchivedTasksScreen);
...
export default connect(mapStateToProps)(EnhancedArchivedTasksScreen);
