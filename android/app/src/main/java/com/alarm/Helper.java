...
import com.tasker.R;
import com.tasker.ReminderActivity;
...
class Helper {
    ...
    static void cancelAllNotification(Context context) {
        NotificationManager manager = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
        manager.cancelAll();
    }
    ...
    protected static Notification getNotification(Context context, int id, String alarmUid, String title, String description) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            int largeIconResId = res.getIdentifier("bootsplash_logo", "mipmap", packageName);
    ...
    static Calendar getDate(int year,int month,int date, int hour, int minutes) {
        Calendar d = Calendar.getInstance();
        d.set(Calendar.YEAR,year);
        d.set(Calendar.MONTH,month);
        d.set(Calendar.DATE, date);
        d.set(Calendar.HOUR_OF_DAY, hour);
        d.set(Calendar.MINUTE, minutes);
