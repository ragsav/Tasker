...
public class Module extends ReactContextBaseJavaModule {
    ...
    private Alarm parseAlarmObject (ReadableMap alarm) {
        ...
        int year = alarm.getInt("year");
        int month = alarm.getInt("month");
        int date = alarm.getInt("date");
        int hour = alarm.getInt("hour");
        int minutes = alarm.getInt("minutes");


        return new Alarm(uid, year,month,date,hour, minutes,  title, description);
    }
    ...
    private WritableMap serializeAlarmObject (Alarm alarm) {
        ...
        map.putInt("year", alarm.year);
        map.putInt("month", alarm.month);
        map.putInt("date", alarm.date);
    ...
    // private WritableNativeArray serializeAlarm (Alarm a) {
    //     return serializeAlarmObject(a);
    // }
